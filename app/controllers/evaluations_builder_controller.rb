class EvaluationsBuilderController < ApplicationController
  ...
  def update
    if @evaluation.update(evaluation_params)
      redirect_to evaluation_path(id: @evaluation.id)
    else
      render params[:step]
    end
  end
  ...
  def new
    ...
    @evaluation.save
    redirect_to evaluation_builder_path(step: 'informations', evaluation_id: @evaluation.id)
  end
